...
Welcome! I'm **Jinrui Sun(孙锦瑞)**, I completed my undergraduate studies at the School of Software, Nankai University, and I am currently a graduate student at Peking University. My academic advisors are professer [Tong Jia](https://scholar.google.com/citations?user=uGqZIQsAAAAJ&hl=zh-CN) and [Prof. Ying Li](https://ss.pku.edu.cn/sztd/xssbsz/cd38cb490d9648ba863cffea67a1a941.htm), and my research inerests focuses on LLM/Agents & RSI and Automated SE.
...
- <b style="color: #224B8D;">\[WWW 2026\]</b> **VarParser: Unleashing the Neglected Power of Variables for LLM-based Log Parsing**.  
  <u>Jinrui Sun</u>, Tong Jia, Minghua He, Ying Li.  
  In the proceedings of the 2026 ACM Web Conference <b style="color: rgb(242,103,103);">(Oral, 317/3370, Top 9.4%)</b>. \[[paper](https://dl.acm.org/doi/10.1145/3774904.3792095)\] \[[code](https://github.com/mianmaner/VarParser)\] <b style="color:#3B866E;">(CCF-A)</b>
...
- <b style="color: #224B8D;">\[ISSRE 2025\]</b> **Too Many Cooks: Assessing the Need for Multi-Source Data in Microservice Failure Diagnosis**.  
  ...
  In the proceedings of the 2025 IEEE International Symposium on Software Reliability Engineering. \[[paper](https://nkcs.iops.ai/wp-content/uploads/2026/01/Too_Many_Cooks_Assessing_the_Need_for_Multi-Source_Data_in_Microservice_Failure_Diagnosis.pdf)] \[[code](https://github.com/flyingnobe/Empirical-Study-on-Multi-source-Failure-Diagnosis)] <b style="color:#3B866E;">(CCF-B)</b>
...
- <b style="color: #224B8D;">\[ASE 2024\]</b> **Giving Every Modality a Voice in Microservice Failure Diagnosis via Multimodal Adaptive Optimization**.  
  ...
  In the proceedings of the 2024 IEEE/ACM International Conference on Automated Software Engineering. \[[paper](https://nkcs.iops.ai/wp-content/uploads/2024/10/ASE24-Medicine.pdf)\] \[[code](https://github.com/AIOps-Lab-NKU/Medicine)\] <b style="color:#3B866E;">(CCF-A)</b>
